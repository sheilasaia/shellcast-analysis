...
def tidy_sco_ndfd_data(ndfd_data, datetime_uct_str, ndfd_var):
    ...
    # if desired times are avilable
    if (len(var_data_pd) > 0):
    ...
    # if desired times are not available
    else:
        # print status
...
# loop!
for date in range(17, 20): #len(datetime_list_pd)): #range(0, len(datetime_list_pd)):
    # grab datetime
...
# issue with pop12 on date = 19 (2016012000)
# issue with date = 103, 104 (no data at all for 20160413 and no midnight time for 20160414)
# issue with 