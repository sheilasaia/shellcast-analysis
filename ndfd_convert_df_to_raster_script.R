...
nc_buffer_wgs84 <- st_read(paste0(nc_buffer_spatial_input_path, "nc_bounds_10kmbuf_wgs84.shp")) %>%
  st_set_crs(wgs84_epsg) # epsg code wasn't assigned if this code isn't included
# st_crs(nc_buffer_wgs84) # checks!
...
ndfd_pop12_wgs84 <- st_as_sf(ndfd_pop12_data, 
...
# st_crs(ndfd_pop12_wgs84)
# look good!

# pop12 periods available
# unique(ndfd_pop12_wgs84$valid_period_hrs)


# select 1-day pop12
ndfd_pop12_wgs84_1day <- ndfd_pop12_wgs84 %>%
  dplyr::filter(valid_period_hrs == 24)

# select 2-day pop12
ndfd_pop12_wgs84_2day <- ndfd_pop12_wgs84 %>%
  dplyr::filter(valid_period_hrs == 48)

# select 3-day pop12
ndfd_pop12_wgs84_3day <- ndfd_pop12_wgs84 %>%
  dplyr::filter(valid_period_hrs == 72)


# qpf
# convert qpf to spatial data
ndfd_qpf_wgs84 <- st_as_sf(ndfd_qpf_data, 
                            coords = c("longitude_m", "latitude_m"), 
                            crs = ndfd_proj4, 
                            dim = "XY") %>%
  st_transform(crs = wgs84_epsg)
...
# st_crs(ndfd_qpf_wgs84)
# look good!

# qpf periods available
# unique(ndfd_qpf_wgs84$valid_period_hrs)


# select 1-day qpf
ndfd_qpf_wgs84_1day <- ndfd_qpf_wgs84 %>%
  dplyr::filter(valid_period_hrs == 24)

# select 2-day qpf
ndfd_qpf_wgs84_2day <- ndfd_qpf_wgs84 %>%
  dplyr::filter(valid_period_hrs == 48)

# select 3-day qpf
ndfd_qpf_wgs84_3day <- ndfd_qpf_wgs84 %>%
  dplyr::filter(valid_period_hrs == 72)
...
ndfd_pop12_raster_1day_wgs84 <- raster::rasterize(ndfd_pop12_wgs84_1day, ndfd_pop12_grid_1day, field = ndfd_pop12_wgs84_1day$pop12_value_perc, fun = mean)
ndfd_pop12_raster_2day_wgs84 <- raster::rasterize(ndfd_pop12_wgs84_2day, ndfd_pop12_grid_2day, field = ndfd_pop12_wgs84_2day$pop12_value_perc, fun = mean)
ndfd_pop12_raster_3day_wgs84 <- raster::rasterize(ndfd_pop12_wgs84_3day, ndfd_pop12_grid_3day, field = ndfd_pop12_wgs84_3day$pop12_value_perc, fun = mean)
# crs(ndfd_pop12_grid_1day_wgs84)

# rasterize qpf for 1-day, 2-day, and 3-day forecasts
ndfd_qpf_raster_1day_wgs84 <- raster::rasterize(ndfd_qpf_wgs84_1day, ndfd_qpf_grid_1day, field = ndfd_qpf_wgs84_1day$qpf_value_in, fun = mean)
ndfd_qpf_raster_2day_wgs84 <- raster::rasterize(ndfd_qpf_wgs84_2day, ndfd_qpf_grid_2day, field = ndfd_qpf_wgs84_2day$qpf_value_in, fun = mean)
ndfd_qpf_raster_3day_wgs84 <- raster::rasterize(ndfd_qpf_wgs84_3day, ndfd_qpf_grid_3day, field = ndfd_qpf_wgs84_3day$qpf_value_in, fun = mean)


# plot to check
# plot(ndfd_pop12_raster_1day_wgs84)
# plot(ndfd_qpf_raster_1day_wgs84)
# plot(ndfd_pop12_raster_2day_wgs84)
# plot(ndfd_qpf_raster_2day_wgs84)
# plot(ndfd_pop12_raster_3day_wgs84)
# plot(ndfd_qpf_raster_3day_wgs84)


# ---- 9. crop midatlantic raster ndfd data to nc bounds ----
# pop12 for 1-day, 2-day, and 3-day forecasts
ndfd_pop12_raster_1day_nc_wgs84 <- raster::crop(ndfd_pop12_raster_1day_wgs84, nc_buffer_wgs84)
ndfd_pop12_raster_2day_nc_wgs84 <- raster::crop(ndfd_pop12_raster_2day_wgs84, nc_buffer_wgs84)
ndfd_pop12_raster_3day_nc_wgs84 <- raster::crop(ndfd_pop12_raster_3day_wgs84, nc_buffer_wgs84)

# qpf for 1-day, 2-day, and 3-day forecasts
ndfd_qpf_raster_1day_nc_wgs84 <- raster::crop(ndfd_qpf_raster_1day_wgs84, nc_buffer_wgs84)
ndfd_qpf_raster_2day_nc_wgs84 <- raster::crop(ndfd_qpf_raster_2day_wgs84, nc_buffer_wgs84)
ndfd_qpf_raster_3day_nc_wgs84 <- raster::crop(ndfd_qpf_raster_3day_wgs84, nc_buffer_wgs84)

# plot to check
# plot(nc_buffer_wgs84)
...
# ndfd_pop12_raster_1day_nc_wgs84 <- projectRaster(ndfd_pop12_raster_1day_nc_wgs84, crs = wgs84_proj4)
# ndfd_pop12_raster_2day_nc_wgs84 <- projectRaster(ndfd_pop12_raster_2day_nc_wgs84, crs = wgs84_proj4)
# ndfd_pop12_raster_3day_nc_wgs84 <- projectRaster(ndfd_pop12_raster_3day_nc_wgs84, crs = wgs84_proj4)

# project qpf to wgs84 too for 1-day, 2-day, and 3-day forecasts
# ndfd_qpf_raster_1day_nc_wgs84 <- projectRaster(ndfd_qpf_raster_1day_nc_wgs84, crs = wgs84_proj4)
# ndfd_qpf_raster_2day_nc_wgs84 <- projectRaster(ndfd_qpf_raster_2day_nc_wgs84, crs = wgs84_proj4)
# ndfd_qpf_raster_3day_nc_wgs84 <- projectRaster(ndfd_qpf_raster_3day_nc_wgs84, crs = wgs84_proj4)
...
writeRaster(ndfd_pop12_raster_1day_nc_wgs84, paste0(ndfd_sco_spatial_data_output_path, "pop12_24hr_nc_wgs84.tif"), overwrite = TRUE)
writeRaster(ndfd_pop12_raster_2day_nc_wgs84, paste0(ndfd_sco_spatial_data_output_path, "pop12_48hr_nc_wgs84.tif"), overwrite = TRUE)
writeRaster(ndfd_pop12_raster_3day_nc_wgs84, paste0(ndfd_sco_spatial_data_output_path, "pop12_72hr_nc_wgs84.tif"), overwrite = TRUE)

# export qpf rasters for 1-day, 2-day, and 3-day forecasts
writeRaster(ndfd_qpf_raster_1day_nc_wgs84, paste0(ndfd_sco_spatial_data_output_path, "qpf_24hr_nc_wgs84.tif"), overwrite = TRUE)
writeRaster(ndfd_qpf_raster_2day_nc_wgs84, paste0(ndfd_sco_spatial_data_output_path, "qpf_48hr_nc_wgs84.tif"), overwrite = TRUE)
writeRaster(ndfd_qpf_raster_3day_nc_wgs84, paste0(ndfd_sco_spatial_data_output_path, "qpf_72hr_nc_wgs84.tif"), overwrite = TRUE)
